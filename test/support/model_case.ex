defmodule PhoenixEncounterThing.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import PhoenixEncounterThing.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&PhoenixEncounterThing.ErrorHelpers.translate_error/1)
